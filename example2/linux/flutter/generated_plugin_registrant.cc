...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) river_player_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "RiverPlayerPlugin");
  river_player_plugin_register_with_registrar(river_player_registrar);
